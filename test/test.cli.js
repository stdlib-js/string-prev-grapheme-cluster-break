...
tape( 'the command-line interface returns the previous grapheme break position in a string', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'--from=3\'; process.argv[ 3 ] = \'अनुच्छेद\'; require( \''+fpath+'\' );"'
	];
